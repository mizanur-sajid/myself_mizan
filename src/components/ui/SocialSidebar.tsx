    ...
    <>
      <AnimatePresence>
        {isVisible && (
          ...
          >
            <a href="https://github.com/mizan" target="_blank" rel="noreferrer" className="social-link github">
            ...
            <a href="https://linkedin.com/in/mizan" target="_blank" rel="noreferrer" className="social-link linkedin">
            ...
            <a href="mailto:example@email.com" className="social-link email">
